...
var builtinComponents = []ComponentDef{
	...
	},
	{
		Name:       "RemoteConfig",
		Level:      Optional,
		ConfigKeys: []string{"RemoteConfig.Type"},
		Desc:       "远程配置中心（Nacos / K8s ConfigMap）",
		Probe:      probeRemoteConfig,
	},
	{
		Name:       "Tracer/OTel",
		Level:      Optional,
		ConfigKeys: []string{"Framework.Tracer.Endpoint"},
	...
	},
	{
		Name:       "Milvus",
		Level:      Optional,
		ConfigKeys: []string{"Framework.Milvus.Address"},
		Desc:       "向量数据库（Milvus）",
		Probe:      probeMilvus,
	},
	{
