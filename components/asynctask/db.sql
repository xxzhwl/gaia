...
(
    ...
    log_id            varchar(64)                            null comment '日志id'
)
    comment '异步任务表' charset = utf8mb3;
...
create index asynctasks_priority_index
    on asynctasks (priority);

create index asynctasks_tenant_id_index
    on asynctasks (tenant_id);
